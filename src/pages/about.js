const About = () => {
  return (
    <div>
      <h1 className="text-sage text-4xl font-bold">About us</h1>
      <div className="text-lg">
        ...
        Join a global community of like-minded travelers who share your passion
        for sustainability and cultural immersion. Share your experiences, tips,
        and learnings with fellow EarthHoppers, amplifying the ripple effect of
        responsible tourism.
        <p className="my-5">
